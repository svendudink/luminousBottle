...
export const presentationMode = () => (
  ...
  >
    ...
    <div key="content-4" className="my-slide content">
      <p>
        See the{" "}
        <a href="./examples/presentation/presentation.scss">source code</a>...
      </p>
    </div>
    ...
    <div key="content-8" className="my-slide content">
      <iframe
        src="https://player.vimeo.com/video/105955605"
        width="640"
        height="360"
      />
    </div>
    ...
    <div key="content-11" className="my-slide content">
      <p>
        ...
        since the <strong>1500s</strong>, when an unknown printer took a galley
        of type and scrambled it to make a type specimen book.{" "}
      </p>
    </div>
    <div key="content-12" className="my-slide content">
      <blockquote>
        It has survived not only <em>five centuries</em>, but also the leap into
        electronic typesetting, remaining essentially unchanged.{" "}
      </blockquote>
    </div>
    <div key="content-13" className="my-slide content">
      <p>
        It was popularised in the <strong>1960s</strong> with the release of
    ...
    <div key="content-16" className="my-slide content">
      <p>
        ...
        <strong>45 BC</strong>, making it over <strong>2000</strong> years old.
      </p>
    </div>
